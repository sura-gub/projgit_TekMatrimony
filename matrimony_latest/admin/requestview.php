...
if (isset($_GET['idxyz']) && isset($_GET['email'])) {
    // Fetch data based on the 'idxyz' parameter and 'email'
    $qry = "SELECT * FROM wedding WHERE email = :email";
    $params = array(':email' => $_GET['email']);
} else {
    // Handle the case where 'idxyz' is not set, or provide a default behavior
}
...
foreach ($sss as $sss2) {
    ...
    // You can access the profile data using $sss2['column_name']
}
    ...
    <div class="row bg-danger-subtle hd">
      <div class="mt-3">
        ...
        <img src="../../matrimony/img/tekmat.png" style="background-color: transparent; width:150px";/>
          ...
          <a href="reqselect.php"> <button class="m-3 btnnn"><img src="img/left-arrows.png" width="20px" alt=""> Back</button> </a>
