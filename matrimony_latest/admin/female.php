                    ...
                    <nav class="navbar navbar-light navbar-expand-xl" id="navBar">
                        ...
                        <div class="collapse navbar-collapse py-3" id="navbarCollapse">
                            <div class="navbar-nav mx-auto border-top">
                                ...
                                <a href="female.php" class="nav-item nav-link active">Female</a>
...
<body
    style="background-image: url('img/Untitled design.png'); min-height: 900px; background-size: cover; background-repeat: no-repeat; background-position: center;"
    class="w-100">
    <!-- Top Navbar -->
    ...
    <div id="main">
        ...
        <div class="apple mt-5">
            <div class="col-md-9">
                ...
                <?php
                $res = $connect->prepare("SELECT * FROM wedding WHERE gender = 'female'");
                $res->execute();
                ...
                while ($row = $res->fetch()) {
                    ...
                    echo '<a class="myDIV" href="femaleview.php?idxyz=' . $row['id'] . '">';

                    if($row['picture']!="") 
                    {
                     
                    echo '<img class="card-img-top my-3 mx-3" src="../img/' . $row['picture'] . '" alt="Card image cap" width="120px" height="170px" style="border-radius: 50%;"></a>';
                    ...
                    else 
                    {
                     ...
                     <div class="d-flex justify-content-center align-items-center">
                      <img  class="rounded  mx-2" src="img/avatar.png" width="120px" alt="Empty" height="170px"></div>
