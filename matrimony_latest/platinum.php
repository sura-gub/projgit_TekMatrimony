        ...
        <div class="container">
            ...
            <div class="card card1 border-silver" style="width: 30rem; height: 200px;">
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item text-muted"> <b><button type="button" class="btn btn-warning" onclick="pl()" data-bs-toggle="modal" data-bs-target="#skipModal"> Proceed <img src="img/rupee.png" width="20px" alt="">1499</button></a></b></li>
                </ul>
              </div>
            </div>
          </div>
