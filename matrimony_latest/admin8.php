  ...
  <div class="container-fluid">
    <div class="row bg-primary-subtle hd">
      <div class="nav-scroller mb-3 mt-3">
        <img src="img/tekmat.png" style="background-color: transparent; width: 150px" class="logo" />
...
?>
    ...
    <div><h4 class="my-2 mx-2"><?php print $sss2['name']; ?></h4></div>
        ...
        <hr>
        <a href="#"> <img src="img/icons8-home-32.png" width="20px">&nbsp;&nbsp;Home</a>
...
<div class="text-center mt-2">
      <h1 class="display-4"><?php print $sss6['name']; ?>'s Profile</h1>
    </div>
        <div class="card col-md-8 mt-5 mai" style="border-radius: 25px; margin: auto;">
  ...
  {
    ?>
    <img src="img/<?php print $sss6['picture']; ?>" width="200px" height="200px" class="card-img-top mx-3" />
    <?php
  } 
  else 
  {
    ?>
   <div class="d-flex justify-content-center align-items-center">
    <img src="img/avatar.png" width="300px" alt="Empty" height="300px" class="rounded p-5 " style="border-radius:30px;">
</div>
...
<div class="text-center mt-5" id="profile-requests">
  ...
  if (isset($_SESSION['loger'])) {
      ...
      $qry = "SELECT * FROM friendrequest WHERE request_to = :loger";
  ...
  <div class="horizontal-scroll-container">
    <div class="profile-row">
      ...
      foreach ($requestedProfiles as $requestedProfile) {
          ...
          $reqTo = $requestedProfile['request_from'];
