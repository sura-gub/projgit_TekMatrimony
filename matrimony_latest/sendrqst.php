...
<body style="background-image:linear-gradient(rgb(255,192,203,0.3)100%,rgb(255,192,203,0.3)100%),url('img/log04.jpg'); min-height: 800px; background-size: 100% 100%; background-repeat: no-repeat; background-position: center;" class="w-100">
  ...
  <div class="row vh-100">
    ...
    <div><h4 class="my-2 mx-2"><?php print $sss6['name']; ?></h4></div>
        ...
        <a href="#"> <img src="img/add-user.png" width="20px">&nbsp;&nbsp;Send Requests</a>
...
<div class="text-center mt-5" id="profile-requests">
    <h1 class="display-6">Send Requests</h1>
  </div>
  <?php
  if (isset($_SESSION['loger'])) {
      $loger = $_SESSION['loger'];

      $qry = "SELECT * FROM friendrequest WHERE request_from = :loger";
      ...
      if($requestedProfiles1==0){
        ...
        <center><p class="text-danger m-5">oops! no send  any requests<img src="img/embarrassed.png" width="50px" height="50"></P></center>
  ...
  <div class="horizontal-scroll-container">
    ...
    <?php
          ...
          $reqTo = $requestedProfile['request_to'];
          ...
          if ($profileData) {
              ...
              echo '<a class="noulne" href="view10.php?idxyz=' . $profileData['id'] . '">';
              echo '<center>';
