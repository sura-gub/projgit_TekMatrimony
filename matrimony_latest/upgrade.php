...
<body style="background-image: url('img/paybg1.jpg'); min-height: 750px; background-size: cover; background-repeat: no-repeat; background-position: center;" class="w-100">
    ...
    <div>
    <img src="img/tekmat.png" width="150px" height="60px" alt="Logo">
<a href="#default" class="logo">upgrade now</a>     <button type="button" class="btn btn-secondary float-end" data-bs-toggle="modal" data-bs-target="#skipModal">Skip <img src="img/icons8-fast-forward-30.png" width="20px" alt=""></button>
        ...
        <div class="container">
            ...
            <div class="card card1 border-silver" style="width: 18rem;">
                ...
                <ul class="list-group list-group-flush">
                  <li class="list-group-item">1 months</li>
                  <li class="list-group-item text-success"><b>SAVE 8%</b></li>
                  <li class="list-group-item text-muted"><del><img src="img/rupee.png" width="20px" alt="">699</del> <b> Pay Now <br><a href="silver.php"><button type="button" class="btn btn-warning" onclick="pl()"><img src="img/rupee.png" width="20px" alt="">299</button></a></b></li>
                </ul>
              </div>
            </div>
            ...
            <div class="card card1 border-warning" style="width: 18rem;">
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item text-muted"><del><img src="img/rupee.png" width="20px" alt="">999</del><b> Pay Now <br><a href="gold.php"><button type="button" class="btn btn-warning"><img src="img/rupee.png" width="20px" alt="">599</button></a></b></li>
                </ul>
              </div>
            </div>
            ...
            <div class="col-lg-4">
              <div class="card card1" style="width: 18rem;">
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item text-muted"><del><img src="img/rupee.png" width="20px" alt="">2999</del><b> Pay Now <br><a href="platinum.php"><button type="button" class="btn btn-warning"><img src="img/rupee.png" width="20px" alt="">1499</button></a></b></li>
                </ul>
              </div>
            </div>
    ...
    <div class="modal fade" id="skipModal" tabindex="-1" aria-labelledby="skipModalLabel" aria-hidden="true">
        ...
        <h6 class="text-center"><b>Offer Valid only today!</b></h6><br>
</body>
<script>
    function pl(){
